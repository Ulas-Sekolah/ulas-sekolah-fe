  ...
  return (
    <footer className="
      ...
      <div>
        ...
        <Text classText="mt-7 font-extralight">Kami hadir menciptakan fitur untuk memudahkan anak bangsa mencari sekolah favoritnya berdasarkan rating, jurusan, ekskul dan fasilitas sekolah. (<span className="text-blue-200 cursor-pointer">selangkapnya...</span>)</Text>
        <Text classText="mt-7 font-medium">Gedung Rating Sekolah, Jl. BB I Cip. Muara No. 29, Jakarta Timur 13420</Text>
      </div>
      <div>
      ...
      <Text classText="mt-0">©RatingSekolah, 2021. All Rights Reserved</Text>
    </footer>
  )
}
