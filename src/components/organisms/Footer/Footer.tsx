    ...
    '>
      ...
      <div className='text-right'>
        ...
        <div className='mt-7 flex justify-end laptop:justify-between desktop:justify-end'>
          <Image src='/assets/images/gplay.png' alt='G-Play' height={40} width={120} layout='fixed' />
          <Image src='/assets/images/appstore.png' alt='App-Store' height={40} width={120} layout='fixed' classWrap='ml-3' />
        </div>
